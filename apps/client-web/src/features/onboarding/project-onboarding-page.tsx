          ...
          steps={[
            {
              id: "name",
              type: "created",
              description: "renseigne l’identité de l’entité",
              user: { name: "Projet", initial: "P", bgColor: "bg-teal-600" },
              activityTime: "Requis",
            },
            {
              id: "activities",
              type: "in progress",
              description: "décrit les activités métier",
              user: { name: "Activités", initial: "A", bgColor: "bg-emerald-600" },
              activityTime: "À compléter",
            },
            {
              id: "standard",
              type: "created",
              description: "prépare le référentiel ISO 9001",
              user: { name: "QHSE", initial: "Q", bgColor: "bg-sky-600" },
              activityTime: "Automatique",
            },
          ]}
        />
      </div>
