    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-slate-600">
          Sélectionnez un projet pour accéder à son espace QHSE.
        </p>
      </div>
      {projects.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-300 bg-white p-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Créez un premier projet depuis l’onboarding.
          </p>
          <Link
            ...
            >
              ...
              <dl className="mt-4 grid grid-cols-2 gap-2 text-sm">
                <div>
                  ...
                  <dd>{project.entityType}</dd>
                </div>
                <div>
                  <dt className="text-slate-500">Référentiel</dt>
                  <dd>ISO 9001</dd>
                </div>
                <div>
              ...
              <Link
                className="mt-5 inline-flex text-sm font-medium text-teal-700 underline"
