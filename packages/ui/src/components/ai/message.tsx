...
export const MessageBranchPrevious = ({ children, ...props }: MessageBranchPreviousProps) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <ChevronLeftIcon size={14} className="rtl:rotate-180" />}
    </Button>
  );
};
...
export const MessageBranchNext = ({ children, className, ...props }: MessageBranchNextProps) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <ChevronRightIcon size={14} className="rtl:rotate-180" />}
    </Button>
  );
};
...
export function MessageAttachments({ children, className, ...props }: MessageAttachmentsProps) {
  ...
  return (
    <div className={cn("ms-auto flex w-fit flex-wrap items-start gap-2", className)} {...props}>
      {children}
    </div>
  );
}
