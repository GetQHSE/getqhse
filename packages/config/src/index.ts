...
export const serverEnvironmentSchema = z.object({
  ...
  OPENAI_PROFILE_MODEL: z.string().min(1).default("gpt-5.6-luna"),
  OPENAI_REGULATORY_MODEL: z.string().min(1).default("gpt-5.6-luna"),
  ...
  OPENAI_REGULATORY_INPUT_USD_PER_MTOK: z.coerce.number().positive().default(0.2),
  OPENAI_REGULATORY_CACHED_INPUT_USD_PER_MTOK: z.coerce.number().positive().default(0.02),
  OPENAI_REGULATORY_OUTPUT_USD_PER_MTOK: z.coerce.number().positive().default(1.2),
